...
That handy thing lives at https://jsonplaceholder.typicode.com/ – it's a simple dummy data service that'll let us do GETs quickly.

While you're at it, in the starter-code folder, we've got a super basic index and a CSS file to get started. Nothing fancy.

Open up your `index.html` in a browser. Make sure to load up that console - we're going to be working with it quite a bit.
...
```js
  var ajax = $.get('https://jsonplaceholder.typicode.com/posts')
```
